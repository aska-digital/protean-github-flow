#!/usr/bin/env bash
# protean-github-flow - standalone installer.
# Usage: bash install.sh --target <dir> [--dry-run]
# Bash and coreutils only. No network access. Prints every path it writes.
set -euo pipefail

SLUG="protean-github-flow"
VERSION="1.0.0"

PAYLOAD=(
  "skills/github-issues"
  "skills/github-issue-to-pr"
  "skills/github-pr-workflow"
  "skills/github-pr-audit"
  "skills/upstream-contribution-pr"
  "gates/protean-github-flow")
