...
class TestInstall(unittest.TestCase):
    ...
    def test_install_copies_declared_payload(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            for rel in ['gates/protean-github-flow', 'skills/github-issue-to-pr', 'skills/github-issues', 'skills/github-pr-audit', 'skills/github-pr-workflow', 'skills/upstream-contribution-pr']:
